# Review — `sam3-fold-phrase-matrix/carved_figure/organ_direct__drapery-folds`

*carved_figure · 'drapery folds' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*

> Matrix cell from the pre-registered suite 'sam3-fold-phrase-matrix': family 'fold_target' (role 'fold_target') against fixture 'carved_figure'. The phrase was frozen before any live call in this lane and may not be changed now.
