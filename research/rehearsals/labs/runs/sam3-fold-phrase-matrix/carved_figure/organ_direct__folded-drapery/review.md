# Review — `sam3-fold-phrase-matrix/carved_figure/organ_direct__folded-drapery`

*carved_figure · 'folded drapery' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
