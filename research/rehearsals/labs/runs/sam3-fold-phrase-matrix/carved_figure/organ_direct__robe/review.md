# Review — `sam3-fold-phrase-matrix/carved_figure/organ_direct__robe`

*carved_figure · 'robe' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
