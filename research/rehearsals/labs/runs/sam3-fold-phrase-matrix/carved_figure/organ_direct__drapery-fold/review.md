# Review — `sam3-fold-phrase-matrix/carved_figure/organ_direct__drapery-fold`

*carved_figure · 'drapery fold' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*

> Matrix cell from the pre-registered suite 'sam3-fold-phrase-matrix': family 'replication_control' (role 'replication_control') against fixture 'carved_figure'. The phrase was frozen before any live call in this lane and may not be changed now.
