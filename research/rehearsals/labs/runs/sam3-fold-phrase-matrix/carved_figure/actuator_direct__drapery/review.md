# Review — `sam3-fold-phrase-matrix/carved_figure/actuator_direct__drapery`

*carved_figure · 'drapery' · actuator_direct · mode `actuator_direct` · locked to `concept_segment` · expected `open`*

> Matrix cell from the pre-registered suite 'sam3-fold-phrase-matrix': family 'object_scope' (role 'object_scope') against fixture 'carved_figure'. The phrase was frozen before any live call in this lane and may not be changed now.
