# Review — `sam3-fold-phrase-matrix/carved_figure/organ_direct__garment`

*carved_figure · 'garment' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
