# Review — `sam3-fold-phrase-matrix/carved_figure/organ_direct__bicycle`

*carved_figure · 'bicycle' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `negative`*

> Matrix cell from the pre-registered suite 'sam3-fold-phrase-matrix': family 'negative_control' (role 'negative_control') against fixture 'carved_figure'. The phrase was frozen before any live call in this lane and may not be changed now.
