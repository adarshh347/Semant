# Review — `sam3-fold-phrase-matrix/carved_figure/organ_direct__fabric-folds`

*carved_figure · 'fabric folds' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
