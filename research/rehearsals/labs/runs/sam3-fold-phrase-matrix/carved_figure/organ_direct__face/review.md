# Review — `sam3-fold-phrase-matrix/carved_figure/organ_direct__face`

*carved_figure · 'face' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `positive`*
