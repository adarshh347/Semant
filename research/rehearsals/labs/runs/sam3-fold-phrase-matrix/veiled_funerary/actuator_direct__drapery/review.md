# Review — `sam3-fold-phrase-matrix/veiled_funerary/actuator_direct__drapery`

*veiled_funerary · 'drapery' · actuator_direct · mode `actuator_direct` · locked to `concept_segment` · expected `open`*

> Matrix cell from the pre-registered suite 'sam3-fold-phrase-matrix': family 'object_scope' (role 'object_scope') against fixture 'veiled_funerary'. The phrase was frozen before any live call in this lane and may not be changed now.
...
|---|---|
| prompt | — |
| control phrase | `drapery` |
| phrase actually used | `drapery` |
...
**empty_ambiguous_pending_review** — the organ measured no instance of 'drapery'. Whether that is true absence or a missed detection is a review question, not a measured one
