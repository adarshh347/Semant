# Review — `sam3-fold-phrase-matrix/veiled_funerary/organ_direct__garment`

*veiled_funerary · 'garment' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
...
|---|---|
| prompt | — |
| control phrase | `garment` |
| phrase actually used | `garment` |
...
**organ_succeeded** — the organ measured 1 instance(s) of 'garment'. Whether those instances ARE that concept is not established here
