# Review — `sam3-fold-phrase-matrix/veiled_funerary/organ_direct__drapery-fold`

*veiled_funerary · 'drapery fold' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*

> Matrix cell from the pre-registered suite 'sam3-fold-phrase-matrix': family 'replication_control' (role 'replication_control') against fixture 'veiled_funerary'. The phrase was frozen before any live call in this lane and may not be changed now.
