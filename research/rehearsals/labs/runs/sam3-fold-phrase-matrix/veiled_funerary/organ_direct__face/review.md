# Review — `sam3-fold-phrase-matrix/veiled_funerary/organ_direct__face`

*veiled_funerary · 'face' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `positive`*
