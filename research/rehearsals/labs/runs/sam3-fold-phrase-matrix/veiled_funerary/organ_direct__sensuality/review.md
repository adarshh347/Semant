# Review — `sam3-fold-phrase-matrix/veiled_funerary/organ_direct__sensuality`

*veiled_funerary · 'sensuality' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `adversarial`*

> Matrix cell from the pre-registered suite 'sam3-fold-phrase-matrix': family 'adversarial_abstraction' (role 'adversarial_abstraction') against fixture 'veiled_funerary'. The phrase was frozen before any live call in this lane and may not be changed now.
