# Review — `sam3-fold-phrase-matrix/veiled_funerary/organ_direct__folded-drapery`

*veiled_funerary · 'folded drapery' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
...
**empty_ambiguous_pending_review** — the organ measured no instance of 'folded drapery'. Whether that is true absence or a missed detection is a review question, not a measured one
