# Review — `sam3-fold-phrase-matrix/veiled_funerary/organ_direct__drapery-folds`

*veiled_funerary · 'drapery folds' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*

> Matrix cell from the pre-registered suite 'sam3-fold-phrase-matrix': family 'fold_target' (role 'fold_target') against fixture 'veiled_funerary'. The phrase was frozen before any live call in this lane and may not be changed now.
...
|---|---|
| prompt | — |
| control phrase | `drapery folds` |
| phrase actually used | `drapery folds` |
| phrase source | control |
| planner | — (not_applicable) |
| image | `research/rehearsals/fixtures/004-gesture-and-address/neighbour-veiled-funerary.jpg` |
...
**empty_ambiguous_pending_review** — the organ measured no instance of 'drapery folds'. Whether that is true absence or a missed detection is a review question, not a measured one
