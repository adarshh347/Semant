# Review — `sam3-fold-phrase-matrix/veiled_funerary/organ_direct__drapery`

*veiled_funerary · 'drapery' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
