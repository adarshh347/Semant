# Review — `sam3-fold-phrase-matrix/veiled_funerary/organ_direct__robe-folds`

*veiled_funerary · 'robe folds' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
...
**empty_ambiguous_pending_review** — the organ measured no instance of 'robe folds'. Whether that is true absence or a missed detection is a review question, not a measured one
