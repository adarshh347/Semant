# Review — `sam3-fold-phrase-matrix/veiled_funerary/organ_direct__bicycle`

*veiled_funerary · 'bicycle' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `negative`*

> Matrix cell from the pre-registered suite 'sam3-fold-phrase-matrix': family 'negative_control' (role 'negative_control') against fixture 'veiled_funerary'. The phrase was frozen before any live call in this lane and may not be changed now.
