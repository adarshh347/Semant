# Review — `sam3-fold-phrase-matrix/veiled_funerary/organ_direct__creases`

*veiled_funerary · 'creases' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
...
|---|---|
| prompt | — |
| control phrase | `creases` |
| phrase actually used | `creases` |
...
**empty_ambiguous_pending_review** — the organ measured no instance of 'creases'. Whether that is true absence or a missed detection is a review question, not a measured one
