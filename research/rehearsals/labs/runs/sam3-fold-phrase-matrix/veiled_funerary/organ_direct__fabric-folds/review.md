# Review — `sam3-fold-phrase-matrix/veiled_funerary/organ_direct__fabric-folds`

*veiled_funerary · 'fabric folds' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
...
|---|---|
| prompt | — |
| control phrase | `fabric folds` |
| phrase actually used | `fabric folds` |
...
**empty_ambiguous_pending_review** — the organ measured no instance of 'fabric folds'. Whether that is true absence or a missed detection is a review question, not a measured one
