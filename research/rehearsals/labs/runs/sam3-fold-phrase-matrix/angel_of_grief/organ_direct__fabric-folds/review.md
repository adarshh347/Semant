# Review — `sam3-fold-phrase-matrix/angel_of_grief/organ_direct__fabric-folds`

*angel_of_grief · 'fabric folds' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
