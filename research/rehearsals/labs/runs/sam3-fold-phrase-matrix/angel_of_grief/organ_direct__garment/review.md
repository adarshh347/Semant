# Review — `sam3-fold-phrase-matrix/angel_of_grief/organ_direct__garment`

*angel_of_grief · 'garment' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
