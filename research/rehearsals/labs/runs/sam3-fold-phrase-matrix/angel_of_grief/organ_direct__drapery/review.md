# Review — `sam3-fold-phrase-matrix/angel_of_grief/organ_direct__drapery`

*angel_of_grief · 'drapery' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
