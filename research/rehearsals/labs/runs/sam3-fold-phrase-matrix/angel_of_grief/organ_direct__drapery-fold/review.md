# Review — `sam3-fold-phrase-matrix/angel_of_grief/organ_direct__drapery-fold`

*angel_of_grief · 'drapery fold' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*

> Matrix cell from the pre-registered suite 'sam3-fold-phrase-matrix': family 'replication_control' (role 'replication_control') against fixture 'angel_of_grief'. The phrase was frozen before any live call in this lane and may not be changed now.
...
**organ_succeeded** — the organ measured 1 instance(s) of 'drapery fold'. Whether those instances ARE that concept is not established here
