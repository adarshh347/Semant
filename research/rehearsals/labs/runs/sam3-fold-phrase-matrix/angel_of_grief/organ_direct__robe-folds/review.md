# Review — `sam3-fold-phrase-matrix/angel_of_grief/organ_direct__robe-folds`

*angel_of_grief · 'robe folds' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
