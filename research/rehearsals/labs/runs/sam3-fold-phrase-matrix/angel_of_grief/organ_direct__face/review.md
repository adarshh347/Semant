# Review — `sam3-fold-phrase-matrix/angel_of_grief/organ_direct__face`

*angel_of_grief · 'face' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `positive`*
