# Review — `sam3-fold-phrase-matrix/angel_of_grief/organ_direct__robe`

*angel_of_grief · 'robe' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
...
**organ_succeeded** — the organ measured 1 instance(s) of 'robe'. Whether those instances ARE that concept is not established here
