# Review — `sam3-fold-phrase-matrix/pieta/organ_direct__fabric-folds`

*pieta · 'fabric folds' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
