# Review — `sam3-fold-phrase-matrix/pieta/organ_direct__garment`

*pieta · 'garment' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
...
| lock held | yes |
| cold / warm | warm |
| latency | 5814 ms (load 0 ms) |
| organ status | **ok** |
| instances | 6 |
| mask areas (px) | 12475, 3614, 4086, 2089, 4335, 884 |
| max pairwise IoU | 0.884 |
| all masks well-formed | yes |
| invariants held | yes |

## Attribution

**organ_succeeded** — the organ measured 6 instance(s) of 'garment'. Whether those instances ARE that concept is not established here
