# Review — `sam3-fold-phrase-matrix/pieta/organ_direct__face`

*pieta · 'face' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `positive`*
...
| lock held | yes |
| cold / warm | cold |
| latency | 1.603e+04 ms (load 3 ms) |
| organ status | **ok** |
| instances | 3 |
