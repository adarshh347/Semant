# Review — `sam3-fold-phrase-matrix/pieta/organ_direct__sensuality`

*pieta · 'sensuality' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `adversarial`*

> Matrix cell from the pre-registered suite 'sam3-fold-phrase-matrix': family 'adversarial_abstraction' (role 'adversarial_abstraction') against fixture 'pieta'. The phrase was frozen before any live call in this lane and may not be changed now.
