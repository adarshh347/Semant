# Review — `sam3-fold-phrase-matrix/pieta/actuator_direct__face`

*pieta · 'face' · actuator_direct · mode `actuator_direct` · locked to `concept_segment` · expected `positive`*

> Matrix cell from the pre-registered suite 'sam3-fold-phrase-matrix': family 'availability_control' (role 'availability_control') against fixture 'pieta'. The phrase was frozen before any live call in this lane and may not be changed now.
