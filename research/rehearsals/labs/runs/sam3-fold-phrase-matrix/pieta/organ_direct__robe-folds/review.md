# Review — `sam3-fold-phrase-matrix/pieta/organ_direct__robe-folds`

*pieta · 'robe folds' · organ_direct · mode `organ_direct` · locked to `concept_segment` · expected `open`*
